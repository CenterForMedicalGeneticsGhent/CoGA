...
CREATE TABLE IF NOT EXISTS family_members (
    ...
    clinical_status TEXT NOT NULL DEFAULT 'unknown' CHECK (clinical_status IN ('unknown', 'unaffected', 'affected')),
    carrier_status TEXT NOT NULL DEFAULT 'unknown' CHECK (carrier_status IN ('unknown', 'not_carrier', 'carrier')),
    carrier_type TEXT CHECK (carrier_type IN ('obligate', 'proven', 'reported', 'inferred')),
    carrier_evidence JSONB NOT NULL DEFAULT '{}'::jsonb,
